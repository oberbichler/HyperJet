import unittest
from hyperjet import HyperJetXd as HyperJet
import numpy as np
...
class TestHyperJet(unittest.TestCase):
    ...
    def test_hyperjet_equal_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_inequal_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_less_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_greater_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_less_or_equal_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_greater_or_equal_than(self):
        a = HyperJet(3, [])
    ...
    def test_hyperjet_variable(self):
        a = HyperJet.variable(f=3, size=5, index=3)
    ...
    def test_hyperjet_throws_when_dimensions_dont_match(self):
        ...
        with self.assertRaises(RuntimeError) as _:
            HyperJet(1, [1, 2, 3], [[1, 2], [3, 4]])

        lhs = HyperJet(2, [1, 2])
        rhs = HyperJet(3, [1, 2, 3])
